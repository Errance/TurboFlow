    ...
    markets: [
      {
        ...
        market: buttonMarket('欧冠冠军', [
          ...binaryCandidate('real-madrid', '皇家马德里', 4.20),
          ...binaryCandidate('man-city', '曼城', 4.80),
          ...binaryCandidate('psg', '巴黎圣日耳曼', 5.60),
          ...binaryCandidate('bayern', '拜仁慕尼黑', 6.20),
          ...binaryCandidate('arsenal', '阿森纳', 7.40),
        ]),
        description: '预测本赛季 UEFA Champions League 最终冠军，按官方冠军结果结算；每个候选按 YES + NO 两个二元子市场独立结算。',
        status: 'open',
      },
      {
        id: 'ucl-finalist',
      ...
      },
      {
        ...
        description: '预测两回合淘汰赛最终晋级方。常规时间、加时和点球均按官方晋级结果处理；每个候选按 YES + NO 两个二元子市场独立结算。',
        status: 'open',
      },
    ],
  },
